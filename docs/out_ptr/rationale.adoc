...
Below is the rationale for the design. Most of this rationale can also be found in https://theztd.github.io/vendor/future_cxx/papers/d1132.html[p1132 - std::out_ptr].
