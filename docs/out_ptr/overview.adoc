...
- Understand the pitfalls and problems that come with C++ by reading the link:caveats[the Caveats].
- Read up on how to use it with your link:customization[custom smart pointers], if you do not have a conforming interface!
