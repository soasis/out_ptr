...
namespace boost {
	...
	class simple_inout_ptr_t : public out_ptr_detail::base_inout_ptr_impl<Smart, Pointer, std::tuple<Args...>, boost::mp11::make_index_sequence<std::tuple_size<std::tuple<Args...>>::value>> {
