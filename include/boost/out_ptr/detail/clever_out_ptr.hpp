...
namespace detail {
	...
	class BOOST_OUT_PTR_TRIVIAL_ABI clever_out_ptr_t : public clever_out_ptr_impl<Smart, Pointer, std::tuple<Args...>, boost::mp11::make_index_sequence<std::tuple_size<std::tuple<Args...>>::value>> {
	private:
