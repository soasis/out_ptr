...
namespace boost {
	...
	class simple_out_ptr_t : public out_ptr_detail::base_out_ptr_impl<Smart, Pointer, std::tuple<Args...>, boost::mp11::make_index_sequence<std::tuple_size_v<std::tuple<Args...>>>> {
	private:
